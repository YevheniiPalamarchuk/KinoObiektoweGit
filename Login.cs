...
namespace kino
{
    public partial class Login : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Proszę podać Login", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtLogin.Focus();
                return;
            }
            if (txtPassword.Text == String.Empty)
            {
                MessageBox.Show("Proszę podać Password", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtPassword.Focus();
                return;
            }
...
{0}", error.Message), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ...
            {
                MessageBox.Show(String.Format(@"Nie istnieje takiego Login !!!"), "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtLogin.Focus();
                return;
            }
